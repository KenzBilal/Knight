...
// It tracks full-page scroll and draws a glowing stroke as user scrolls down.

const SPRING_CONFIG = { stiffness: 80, damping: 25, restDelta: 0.001 } as const;
...
export function ScrollPathDecoration({
  className = "",
  pageRef,
}: {
  className?: string;
  ...
  // Spring smoothing — eliminates jank, feels buttery
...
function KnightPath({ scrollYProgress }: { scrollYProgress: MotionValue<number> }) {
  // Draw from 0 → full as page is scrolled 0 → 100%
  ...
  return (
    ...
    >
      <defs>
        ...
        {/* Sharper inner glow */}
        <filter id="kglow2" x="-20%" y="-20%" width="140%" height="140%">
