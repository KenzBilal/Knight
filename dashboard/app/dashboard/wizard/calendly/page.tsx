    ...
    >
        ...
        <WizardCard title="Why Calendly?" description="Include your scheduling link in emails" icon={<span className="text-2xl">📅</span>}>
          <div className="space-y-4">
            ...
            <div className="rounded-xl bg-white/[0.04] border border-white/[0.06] p-4">
              <p className="text-xs text-[#525252] mb-2">Example:</p>
              <p className="text-sm text-[#a3a3a3] italic">
                &quot;...Feel free to grab a time: <span className="text-white">calendly.com/yourname</span>&quot;
              </p>
            </div>
          </div>
        </WizardCard>
      ...
      {step === 1 && (
        <WizardCard title="Your Calendly Link" description="Paste your scheduling page URL" icon={<span className="text-2xl">🔗</span>}>
          <div className="space-y-4">
            <div>
              <label className="block text-sm text-[#a3a3a3] mb-1.5">Calendly URL</label>
            ...
            <div className="rounded-xl bg-white/[0.04] border border-white/[0.06] p-4">
              <p className="text-xs text-[#525252] mb-2">How to find your link:</p>
              <ol className="text-xs text-[#a3a3a3] space-y-1 list-decimal list-inside">
                <li>Go to <a href="https://calendly.com" target="_blank" rel="noopener noreferrer" className="text-white hover:underline">calendly.com</a></li>
                <li>Click &quot;Copy link&quot; on your event type</li>
                <li>Paste it above</li>
              </ol>
            </div>
            {!calendlyLink && <p className="text-xs text-[#525252]">You can skip this and add it later.</p>}
          </div>
        </WizardCard>
      )}
          ...
          <div className="space-y-4">
            <div className="rounded-xl bg-white/[0.04] border border-white/[0.06] p-6">
              ...
              <div className="space-y-3 text-sm text-[#a3a3a3]">
                ...
                <p>Book a quick call: <span className="text-white">{calendlyLink || "calendly.com/yourname"}</span></p>
