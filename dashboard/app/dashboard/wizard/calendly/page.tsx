    ...
    >
        ...
        <WizardCard title="Why Calendly?" description="Include your scheduling link in emails" icon={<span className="text-2xl">📅</span>}>
          <div className="space-y-4">
            ...
            <div className="rounded-lg bg-white border border-[#ebebeb] p-4">
              <p className="text-xs text-[#888] mb-2">Example:</p>
              <p className="text-sm text-[#666] italic">
                &quot;...Feel free to grab a time: <span className="text-[#111]">calendly.com/yourname</span>&quot;
              </p>
            </div>
          </div>
        </WizardCard>
      ...
      {step === 1 && (
        <WizardCard title="Your Calendly Link" description="Paste your scheduling page URL" icon={<span className="text-2xl">🔗</span>}>
          <div className="space-y-4">
            <div>
              <label className="block text-sm text-[#666] mb-1.5">Calendly URL</label>
            ...
            <div className="rounded-lg bg-white border border-[#ebebeb] p-4">
              <p className="text-xs text-[#888] mb-2">How to find your link:</p>
              <ol className="text-xs text-[#666] space-y-1 list-decimal list-inside">
                <li>Go to <a href="https://calendly.com" target="_blank" rel="noopener noreferrer" className="text-[#111] hover:underline">calendly.com</a></li>
                <li>Click &quot;Copy link&quot; on your event type</li>
                <li>Paste it above</li>
              </ol>
            </div>
            {!calendlyLink && <p className="text-xs text-[#888]">You can skip this and add it later.</p>}
          </div>
        </WizardCard>
      )}
          ...
          <div className="space-y-4">
            <div className="rounded-lg bg-white border border-[#ebebeb] p-6">
              ...
              <div className="space-y-3 text-sm text-[#666]">
                ...
                <p>Book a quick call: <span className="text-[#111]">{calendlyLink || "calendly.com/yourname"}</span></p>
