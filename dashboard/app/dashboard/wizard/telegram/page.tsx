          ...
          >
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                ...
                className="flex-1 rounded-xl bg-white text-[#080808] font-semibold text-[13px] py-3 transition-all duration-200 hover:shadow-[0_0_0_1px_rgba(255,255,255,0.1),0_8px_32px_rgba(255,255,255,0.1)] active:scale-[0.98] disabled:opacity-30 disabled:cursor-not-allowed disabled:hover:shadow-none"
              >
                Continue
              </button>
            </div>
                ...
                {mode === "userbot" ? (
                  <>
                    <li className="flex items-start gap-2">
                      ...
                      <span>Knight sends a verification code</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#4ade80] mt-0.5">
                        <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  ...
                  <>
                    <li className="flex items-start gap-2">
                      ...
                      <span>Knight connects to your bot</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#4ade80] mt-0.5">
                        <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      ...
                      <span>Bot starts receiving messages</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#4ade80] mt-0.5">
                        <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      ...
                      <span>Knight responds automatically</span>
                    </li>
                  </>
                )}
              </ol>
