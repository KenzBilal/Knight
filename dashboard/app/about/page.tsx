        ...
        <div className="space-y-8 text-neutral-400 leading-relaxed">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={i} className="flex items-start gap-3">
                  <span className="text-paper-100 font-mono text-sm mt-0.5">{i + 1}.</span>
                  <span>{item}</span>
                </li>
              ))}
            </ul>
          ...
          <div className="rounded-xl border border-neutral-800 bg-neutral-900/50 p-8 grain-card">
            ...
            <p>
              ...
              <a href="mailto:support@knight.com" className="text-paper-100 hover:underline">support@knight.com</a>
              {" "}or visit our{" "}
              <Link href="/contact" className="text-paper-100 hover:underline">contact page</Link>.
            </p>
          </div>
        </div>
      </div>
