    ...
    <div className="min-h-screen">
      ...
      <div className="mx-auto max-w-4xl px-6 py-24">
        ...
        <div className="space-y-8 text-neutral-400 leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-2xl text-paper-100 mb-4">2. Free Tier</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl text-paper-100 mb-4">4. How to Request</h2>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>Email <a href="mailto:billing@knight.com" className="text-paper-100 hover:underline">billing@knight.com</a></li>
          ...
          <section>
            <h2 className="font-display text-2xl text-paper-100 mb-4">5. Cancellation</h2>
            <p>
              Cancel anytime from your{" "}
              <Link href="/dashboard/billing" className="text-paper-100 hover:underline">billing settings</Link>.
              You keep access until the end of your billing period.
            </p>
          </section>

          <section>
            <h2 className="font-display text-2xl text-paper-100 mb-4">6. Contact</h2>
            <p>
              Questions? Contact us at{" "}
              <a href="mailto:billing@knight.com" className="text-paper-100 hover:underline">billing@knight.com</a>.
            </p>
          </section>
        </div>
      </div>
